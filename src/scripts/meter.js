(function () {
    ...
    let defaultSettings = {
        ...
        width: 'inherit', // width of the bar
        animate: 400, // ms
    ...
    let _validAlignments = ['center', 'left', 'right'];
    let _validEasing = ['swing', 'linear'];
    ...
    function Meter(opts, value) {
        ...
        let defs = clone(defaultSettings);
    ...
    Object.assign(Meter, {
        ...
        add: function (name, opts, value) { // add a new meter; the constructor should not be used
            ...
            let meter = new Meter(opts, value);
    ...
    Macro.add('newmeter', {
        ...
        handler: function () {
            ...
            let meterName = this.args[0],
                colorsTag = null,
                sizeTag = null,
                animTag = null,
                labelTag = null;

            // meter name must be string
            if (typeof meterName !== 'string') {
                return this.error('Invalid meter name. meter name must be string');
            }
